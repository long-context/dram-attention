...
parser.add_argument("--top-k", type=int, default=4096, help="Top-k value for sampling")
parser.add_argument("--page-size", type=int, default=16, help="Page size for retrieval")
...
def load_model(ckpt_dir, max_seq_len: int):
    ...
    model_args: ModelArgs = ModelArgs(
        ...
        max_batch_size=1,
        quest_top_k=FLAGS.top_k,
        quest_page_size=FLAGS.page_size,
        quest_local_attn_window=FLAGS.local_attn_window,
        **params,
    )
...
def generate(
    ...
    # aligned_start_pos is the location where the generation starts
    # where we begin generating tokens (and filling kv-cache) one by one
